...
# {"status":"ok","version":"0.1.2","uptime_seconds":12.3,"local_only":true,"engine":"ned-local-rules"}
```
...
```json
{
  ...
  "engine": { "name": "ned-local-rules", "version": "0.1.2", "provider": "local-rule", "offline": true },
